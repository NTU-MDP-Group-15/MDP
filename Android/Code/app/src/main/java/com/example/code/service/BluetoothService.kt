...
class BluetoothService(
    ...
    private val SDP_NAME = "BluetoothMDP15"
...
//            mAdapter?.listenUsingInsecureRfcommWithServiceRecord(SDP_NAME, MY_UUID)
//        }
//
//        override fun run() {
//            val status = mAdapter?.setName("Code App")
//            val scanMode = mAdapter?.scanMode
