...
from imagerec.utils import TryExcept
from imagerec.utils.downloads import gsutil_getsize
from imagerec.utils.metrics import box_iou, fitness
...
def strip_optimizer(f='best.pt', s=''):  # from imagerec.utils.general import *; strip_optimizer()
