...
from imagerec.utils.general import colorstr, cv2
from imagerec.utils.loggers.clearml.clearml_utils import ClearmlLogger
from imagerec.utils.loggers.wandb.wandb_utils import WandbLogger
from imagerec.utils.plots import plot_images, plot_labels, plot_results
from imagerec.utils.torch_utils import de_parallel
...
class GenericLogger:
    ...
    Usage: from imagerec.utils.loggers import GenericLogger; logger = GenericLogger(...)
    Arguments
        opt:             Run arguments
